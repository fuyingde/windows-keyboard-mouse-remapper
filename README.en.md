...
![Keyboard and Mouse Remapper for Windows in English](./docs/images/app-en-us.png?v=1.8)
...
<table>
  <tr>
    <td align="center"><img src="./docs/images/app-zh-cn.png?v=1.8" width="480" alt="Simplified Chinese interface"><br><sub>简体中文</sub></td>
    <td align="center"><img src="./docs/images/app-zh-tw.png?v=1.8" width="480" alt="Traditional Chinese interface"><br><sub>繁體中文</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="./docs/images/app-ko-kr.png?v=1.8" width="480" alt="Korean interface"><br><sub>한국어</sub></td>
    <td align="center"><img src="./docs/images/app-de-de.png?v=1.8" width="480" alt="German interface"><br><sub>Deutsch</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="./docs/images/app-fr-fr.png?v=1.8" width="480" alt="French interface"><br><sub>Français</sub></td>
    <td align="center"><img src="./docs/images/app-ru-ru.png?v=1.8" width="480" alt="Russian interface"><br><sub>Русский</sub></td>
  </tr>
</table>
...
This app uses global input hooks and simulated input, so a small number of security products may report a false positive. Download builds from this repository's Releases, or inspect the source and build it yourself.
